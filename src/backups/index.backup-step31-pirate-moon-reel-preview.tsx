...
function PirateMoonScreen({
  ...
  const piratePreviewReels = [
    [PIRATE_MOON_SYMBOLS[0], PIRATE_MOON_SYMBOLS[1], PIRATE_MOON_SYMBOLS[2]],
    [PIRATE_MOON_SYMBOLS[3], PIRATE_MOON_SYMBOLS[2], PIRATE_MOON_SYMBOLS[4]],
    [PIRATE_MOON_SYMBOLS[5], PIRATE_MOON_SYMBOLS[1], PIRATE_MOON_SYMBOLS[6]],
    [PIRATE_MOON_SYMBOLS[7], PIRATE_MOON_SYMBOLS[2], PIRATE_MOON_SYMBOLS[0]],
    [PIRATE_MOON_SYMBOLS[4], PIRATE_MOON_SYMBOLS[1], PIRATE_MOON_SYMBOLS[3]],
  ];
      ...
      >
        ...
        <View style={styles.statusCard}>
          ...
          <View style={styles.statusRow}>
            <Text style={styles.statusJackpotText}>ðŸŒ™ Preview Slot</Text>
          </View>
        </View>
        ...
        <View style={styles.piratePreviewBox}>
          ...
          <Text style={styles.piratePreviewTitle}>
            Pirate Moon Jackpot is being prepared.
          </Text>

          <Text style={styles.piratePreviewText}>
            This slot will have its own symbols, theme, jackpot meter, and quest
            flavor. Gameplay will be added step by step after the shell is tested.
          </Text>
        </View>

        <View style={styles.paylineInfoBox}>
          <Text style={styles.paylineInfoTitle}>Middle Payline Preview</Text>
          <Text style={styles.paylineInfoText}>
            Pirate Moon will use the same starter rule: match 3+ symbols from
            left to right on the glowing middle row.
          </Text>
        </View>

        <View style={styles.reelBoard}>
          {piratePreviewReels.map((reel, reelIndex) => (
        ...
        <View style={styles.payoutBox}>
          <Text style={styles.payoutTitle}>Planned Payouts</Text>
        ...
        <TouchableOpacity style={styles.disabledPreviewButton} disabled>
          <Text style={styles.disabledPreviewButtonText}>Gameplay Coming Soon</Text>
        </TouchableOpacity>
