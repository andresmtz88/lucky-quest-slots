...
function PirateMoonScreen({
  ...
  const [pirateHistory, setPirateHistory] = useState<string[]>([]);
  ...
  function addPirateHistoryEntry(entry: string) {
    setPirateHistory((currentHistory) => [entry, ...currentHistory].slice(0, 5));
  }
