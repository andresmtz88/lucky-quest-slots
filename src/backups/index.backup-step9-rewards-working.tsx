...
type Screen = "welcome" | "lobby" | "neonDragon" | "rewards";
...
function RewardsScreen({
  ...
  function claimReward(amount: number, rewardName: string) {
    ...
    <SafeAreaView style={styles.rewardsContainer}>
      ...
      <View style={styles.rewardsCard}>
        ...
        <RewardButton
          ...
          amount={DAILY_BONUS}
          onPress={() => claimReward(DAILY_BONUS, "Daily Bonus")}
        />
        ...
        <RewardButton
          ...
          amount={HOURLY_BONUS}
          onPress={() => claimReward(HOURLY_BONUS, "Hourly Bonus")}
        />
        ...
        <RewardButton
          ...
          onPress={() => claimReward(REWARDED_AD_BONUS, "Rewarded Ad Bonus")}
        />
...
function RewardButton({
  ...
  return (
    <TouchableOpacity style={styles.rewardButton} onPress={onPress}>
      ...
      <Text style={styles.rewardAmount}>+{amount.toLocaleString()}</Text>
    </TouchableOpacity>
  );
}
