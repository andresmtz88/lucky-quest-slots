...
const STORAGE_KEY = "luckyQuestSlotsSaveV1";
...
const SPIN_OBJECTIVE_REWARD = 1500;
const WIN_OBJECTIVE_REWARD = 2000;
const REWARD_CLAIM_OBJECTIVE_REWARD = 1000;
const NEON_DRAGON_OBJECTIVE_REWARD = 1000;

const DAILY_COOLDOWN_MS = 24 * 60 * 60 * 1000;
const HOURLY_COOLDOWN_MS = 60 * 60 * 1000;
