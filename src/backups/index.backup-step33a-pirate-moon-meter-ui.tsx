      ...
      >
        ...
        <View style={styles.pirateMeterBox}>
          <View style={styles.jackpotHeaderRow}>
            ...
            <Text style={styles.jackpotPercent}>0%</Text>
          </View>

          <View style={styles.jackpotTrack}>
            <View style={[styles.pirateMeterFill, { width: "0%" }]} />
          </View>

          <Text style={styles.jackpotText}>
            Coming soon: fill this meter through Pirate Moon spins to unlock a virtual treasure bonus.
          </Text>
        </View>
